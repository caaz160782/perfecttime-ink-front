        ...
        >
          <Grid item sm={12} md={6}>
            <Typography variant="body1">
              Perfect Time INK es una aplicación que busca acompañar al usuario
              en el proceso de la realización de un tatuaje, facilitando el
              proceso para agendar una cita, dándole a conocer de manera
              sencilla y detallada las obras del tatuador con quien desea
              trabajar, brindando las condiciones sanitarias en las que se
              encuentra el estudio, todo esto, con la finalidad de eliminar
            ...
            <Card className={classes.card}>
              ...
              <CardContent>
                ...
                <Typography variant="body2">
                  Descubre porque Perfect Time Ink es la mejor herramienta para
                  llevar un control de tu agenda
                </Typography>
              </CardContent>
              <CardActions>
                <Button
